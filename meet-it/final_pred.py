...
class Application:
    ...
    def __init__(self):
        ...
        # Display accuracy/confidence percentage
        self.panel_conf = tk.Label(self.root, text="Accuracy: {confidence:.2f}%", font=('Helvetica', 24))
        self.panel_conf.place(x=800, y=530)  # adjust position as needed
    ...
    def predict(self, test_image):
        ...
        ch1 = np.argmax(prob)
        confidence = prob[ch1] * 100  # Convert to percentage
        # Show confidence
        self.panel_conf.config(text=f"Accuracy: {confidence:.2f}%")
        print(confidence)
        prob[ch1] = 0
